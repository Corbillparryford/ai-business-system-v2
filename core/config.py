...
# ── Sports thresholds ──────────────────────────────────────────────────────────
# Edge minimum: 1% allows soft-book proxy comparisons to produce opportunities.
# Raise to 3.0 once Pinnacle is confirmed in your OddsAPI subscription.
SPORTS_EV_MIN_EDGE = 1.0
...
# Maximum minutes ahead to consider a game actionable.
# 4320 = 3 days — filters out futures, preseason noise, far-advance lines.
MAX_GAME_WINDOW_MINUTES = 4320

# All sports scanned — ordered by priority (highest liquidity and arb frequency first).
# OddsAPI sport keys: https://the-odds-api.com/sports-odds-data/sports-apis.html
SPORTS_KEYS = [
    # ── Core US sports ──────────────────────────────────────
    "basketball_nba",
    "baseball_mlb",
